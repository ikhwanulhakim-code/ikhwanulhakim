  ...
  <div class="hero-inner">
    <div class="hero-copy">
      ...
      <div class="socials reveal delay-4 in">
        <a href="https://www.instagram.com/ikhwanulhakimm/" target="_blank" rel="noopener" aria-label="Instagram">
...
<section class="block contact" id="contact">
  ...
  <div class="fallback reveal delay-4">
    ...
    <div class="row">
      ...
      <a href="https://www.instagram.com/ikhwanulhakimm/" target="_blank" rel="noopener">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/></svg>
        Instagram
      </a>
    </div>
...
<footer>
  ...
  <div class="socials">
    <a href="https://www.instagram.com/ikhwanulhakimm/" target="_blank" rel="noopener" aria-label="Instagram"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/></svg></a>
